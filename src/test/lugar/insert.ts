...
const mockEvent: APIGatewayProxyEvent = {
  ...
  body: JSON.stringify({
    id_lugar: "lima_lima_peru",
    id_lugar_turistico: "museum_bellas-artes",
    horario: {
      apertura: "09:00",
      cierre: "18:00"
    },
    ...
    zona_geografica: { coords: [-12.04806, -77.02833], pais: "peru", region: "gobiero_lima", provincia: "lima", distrito: "san_gabriel" }
  }),
